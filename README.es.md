...
[![Instalador 2,51 MB](https://img.shields.io/badge/instalador-2,51%20MB-22c55e?style=flat-square)](#instalación)
...
pantalla, gasta 33 MB de memoria y cabe en un instalador de 2,51 MB. Sin cuenta, sin nube, sin telemetría y sin
FFmpeg empaquetado.
...
· 2,51 MB · se instala solo para tu usuario, así que Windows no pide permisos de administrador. Las
