...
[![Installer 2.3 MB](https://img.shields.io/badge/installer-2.3%20MB-22c55e?style=flat-square)](#install)
...
28 ms, uses 33 MB of memory and fits in a 2.3 MB installer. No account, no cloud, no telemetry and
no bundled FFmpeg.
...
· 2.3 MB · it installs for your user only, so Windows never asks for administrator rights. Older
