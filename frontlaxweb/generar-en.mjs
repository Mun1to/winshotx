 ...
 */
const ATRIBUTOS = {
  'content="Alternativa libre a la Herramienta de Recortes de Windows: captura de región, grabación en GIF y MP4 y editor fotograma a fotograma. Abre la selección en 28 ms con una pantalla y gasta 33 MB. Instalador de 2,51 MB, sin cuenta y sin nube."':
    'content="Free and open source alternative to the Windows Snipping Tool: region capture, GIF and MP4 recording and a frame by frame editor. Opens the selection in 28 ms with one screen and uses 33 MB. A 2.51 MB installer, no account and no cloud."',
  ...
  'content="La Herramienta de Recortes tarda 920 ms y gasta 253 MB. Esta tarda 28 ms con una pantalla y gasta 33 MB, graba GIF y trae editor. 2,51 MB, código abierto."':
    'content="The Snipping Tool takes 920 ms and 253 MB. This one takes 28 ms with one screen and 33 MB, records GIF and ships an editor. 2.51 MB, open source."',
  'content="La Herramienta de Recortes tarda 920 ms y gasta 253 MB. Esta tarda 28 ms con una pantalla y gasta 33 MB. 2,51 MB, código abierto."':
    'content="The Snipping Tool takes 920 ms and 253 MB. This one takes 28 ms with one screen and 33 MB. 2.51 MB, open source."',
