      ...
      {error ? (
        <>
          <div className="flex max-w-xl items-start gap-2.5 rounded-xl border border-red-500/30 bg-red-950/60 px-4 py-3 text-sm text-red-200">
            ...
            <span>
              <span className="block font-medium">No se ha podido preparar la captura</span>
        ...
        <>
          ...
          <span className="text-xs text-neutral-400">Preparando la captura… · Esc para salir</span>
        </>
      )}
    </div>
  );
