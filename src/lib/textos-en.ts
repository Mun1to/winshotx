...
export const EN: Record<string, string> = {
  ...
  "winshotx graba la pantalla todo el rato y va tirando lo viejo, así que lo que acaba de pasar sigue estando ahí aunque no le hubieras dado a grabar. Cuesta disco y algo de máquina mientras está encendido: el número que se ve arriba es lo que le escribe al disco cada segundo.": "winshotx records the screen all the time and drops the old, so what just happened is still there even though you never pressed record. It costs disk and some machine while it is on: the number above is what it writes to the disk every second.",
