/**
 * winshotx en ingles. La clave es la frase en espannol tal cual esta en el codigo.
 *
 * Lo que no este aqui sale en espannol, asi que anadir un texto nuevo a la aplicacion no
 * la rompe: solo deja esa frase sin traducir hasta que alguien la anada. Y para un idioma
 * mas, este archivo copiado y traducido, sin tocar ni un componente.
 */
export const EN: Record<string, string> = {
  // La cabecera y las cuatro secciones
  Versión: "Version",
  Capturar: "Capture",
  Grabar: "Record",
  "Teclas de Windows": "Windows keys",
  "La app": "The app",
  ...
  // Capturar
  "Al pulsar el atajo": "When you press the shortcut",
  "Capturar región": "Capture a region",
  "esa combinación está ocupada": "that combination is taken",
  "Esperar antes de capturar": "Wait before capturing",
  "la pantalla se congela al pulsar el atajo": "the screen freezes the moment you press it",
  "da tiempo a abrir el menú que quieres fotografiar":
    "time enough to open the menu you want to shoot",
  "Sin espera": "No wait",
  "3 segundos": "3 seconds",
  "5 segundos": "5 seconds",
  "Ocultar iconos del escritorio": "Hide the desktop icons",
  "solo mientras dura el disparo": "only while the shot is taken",

  "La captura": "The shot",
  "Incluir el cursor": "Include the pointer",
  "Lupa de píxel": "Pixel magnifier",
  "Al soltar el ratón": "When you let go",
  "va directa al portapapeles": "it goes straight to the clipboard",
  "sale la barra para copiar, guardar o editar": "a bar appears: copy, save or edit",
  "Sale la barra": "Show the bar",
  ...
  Fluidez: "Smoothness",
  "esta combinación midió el 86% de un núcleo": "this combination measured 86% of a core",
  "esta combinación midió el 57% de un núcleo": "this combination measured 57% of a core",
  "fotogramas por segundo": "frames per second",
  Nativa: "Native",
  ...
  "Usar también Impr Pant": "Use Print Screen too",
  "hoy abre la Herramienta de Recortes": "today it opens the Snipping Tool",
  "ya es de winshotx": "it belongs to winshotx now",
  "cierra sesión para que Windows la suelte": "sign out so Windows lets go of it",
  "Win + Mayús + S": "Win + Shift + S",
  "Quedarme con Win+Mayús+S": "Take Win+Shift+S",
  "cuesta Win+S, la búsqueda": "it costs you Win+S, the search",
  "de winshotx, o pulsa Aplicar si Windows la sigue abriendo":
    "winshotx has it, or press Apply if Windows keeps opening",
  "el escritorio todavía la tiene": "the desktop still has it",
  "reiniciando el Explorador…": "restarting Explorer…",
  Aplicar: "Apply",
  ...
  "Reinicia el Explorador para que Windows suelte la tecla. La barra de tareas parpadea un segundo y no se cierra nada más.":
    "Restarts Explorer so Windows lets the key go. The taskbar blinks for a second and nothing else closes.",

  "La Herramienta de Recortes": "The Snipping Tool",
  "Herramienta de Recortes": "Snipping Tool",
  "quitarla es lo único que la calla del todo": "removing it is the only way to silence it",
  "vuelve desde la Microsoft Store": "it comes back from the Microsoft Store",
  "quitándola…": "removing it…",
  "quitada, ya no abre nada": "removed, it opens nothing now",
  "no estaba instalada": "it was not installed",
  "Ver cómo": "Show me",
  Quitar: "Remove",
  "Sí, quitarla": "Yes, remove it",
  Hecho: "Done",

  // La app
  Archivos: "Files",
  "Carpeta de destino": "Where things are saved",
  Abrir: "Open",
  Cambiar: "Change",
  "Caché de grabaciones": "Recording cache",
  vacía: "empty",
  "{tam} en {n} {palabra}": "{tam} across {n} {palabra}",
  sesión: "session",
  sesiones: "sessions",
  Vaciar: "Empty it",
  ...
  Aspecto: "Appearance",
  Tema: "Theme",
  "sigue a Windows": "follows Windows",
  Automático: "Automatic",
  Claro: "Light",
  Oscuro: "Dark",
  Idioma: "Language",
  "el de Windows": "the one Windows uses",
  Español: "Spanish",
  Inglés: "English",
  ...
  "instalada, solo falta reiniciar": "installed, it just needs a restart",
  Buscar: "Check",
  ...
  // Las explicaciones largas, las que salen al dejar el ratón sobre el icono
  ...
  "Si el puntero de Windows sale dentro, tal cual y del tamaño que tenga en tu pantalla, en las fotos y en las grabaciones. Es lo más fiel. Apagado, en las grabaciones se anota por dónde va y el editor lo dibuja al exportar del tamaño que quieras, con su misma imagen; en las fotos no sale.": "Whether the Windows pointer shows up inside, as is and at the size it has on your screen, in screenshots and in recordings. It is the most faithful. Turned off, recordings note where it goes and the editor draws it when exporting at whatever size you want, with its very own image; in screenshots it does not show.",
  ...
  "Recortas igual que para una captura, pero en vez de una foto sale un vídeo. El mismo atajo lo termina, así que no hace falta ir a buscar ningún botón mientras grabas.": "You crop the same way as for a screenshot, but what comes out is a video. The same shortcut ends it, so you never have to go looking for a button while recording.",
  "Cuántas veces por segundo se mira la pantalla. 30 vale para casi todo; 60 es para movimiento rápido y cuesta el doble de disco y de máquina. El editor puede bajarlo después, pero lo que no se grabó no se inventa.": "How many times a second the screen is looked at. 30 is enough for almost everything; 60 is for fast movement and costs twice the disk and the machine. The editor can lower it afterwards, but what was not recorded cannot be invented.",
  "Graba lo que suena por los altavoces, dentro del mismo vídeo: la voz de una llamada, el audio de un vídeo, la alerta de un programa. No graba tu micrófono, eso es la fila de abajo.": "Records whatever comes out of the speakers, inside the same video: the voice on a call, the audio of a video, an app's alert. It does not record your microphone, that is the row below.",
  "Tu voz, mezclada con el sonido del sistema en la misma pista. Es lo que hace falta para explicar algo mientras lo enseñas, y solo se puede decidir antes de grabar.": "Your voice, mixed with the system sound into the same track. It is what you need to explain something while you show it, and it can only be decided before recording.",
  "winshotx graba la pantalla todo el rato y va tirando lo viejo, así que lo que acaba de pasar sigue estando ahí aunque no le hubieras dado a grabar. Y cuesta: medido en un equipo con tres pantallas, a 60 fotogramas y resolución nativa se lleva el 86% de un núcleo, y a 30 con 1080 el 57%. Apagado, winshotx entera gasta el 2,9%.": "winshotx records the screen all the time and drops the old, so what just happened is still there even though you never pressed record. And it costs: measured on a machine with three screens, at 60 frames and native resolution it takes 86% of a core, and at 30 with 1080 it takes 57%. Turned off, the whole of winshotx uses 2.9%.",
  "Cuánto tiempo hacia atrás se puede rescatar. Más segundos es más memoria y más disco dando vueltas, y hasta que no pase ese tiempo desde que lo encendiste, lo que guardes durará menos de lo que pone aquí.": "How far back you can rescue. More seconds is more memory and more disk going around, and until that much time has passed since you turned it on, what you save will be shorter than what it says here.",
  "El anillo vigila UNA pantalla y no puede cambiar a mitad, porque mudarse se llevaría por delante lo grabado. Al elegir una, su número aparece un par de segundos en esa misma pantalla para que sepas cuál es.": "The ring watches ONE screen and cannot switch halfway, because moving would take what is already recorded with it. When you pick one, its number appears on that very screen for a couple of seconds so you know which it is.",
  "A qué tamaño se guarda lo que va entrando. Bajarlo de la resolución nativa ocupa mucho menos y se nota poco en pantalla, y aquí abajo tienes lo que puede llegar a ocupar en disco con lo que hayas elegido.": "The size everything is stored at. Below the native resolution it takes far less room and you hardly notice it on screen, and the line under here is how much it can end up taking on disk with what you picked.",
  "Los fotogramas por segundo del anillo. 15 es suficiente para ver qué pasó y es el que menos molesta al ordenador; 60 se ve suave pero escribe cuatro veces más, y esto está corriendo toda la tarde.": "The ring's frames per second. 15 is enough to see what happened and is the one that bothers the machine least; 60 looks smooth but writes four times as much, and this is running all afternoon.",
  "La tecla que rescata. Guarda los últimos segundos y te los abre en el editor **sin dejar de grabar**, así que puedes seguir y volver a rescatar dentro de un rato.": "The key that rescues. It saves the last few seconds and opens them in the editor **without stopping the recording**, so you can carry on and rescue again in a while.",
  "Al parar una grabación, abrirla para recortarla y exportarla. Apagado, el vídeo o el GIF se guarda solo en tu carpeta, entero y tal cual se grabó, y tú sigues a lo tuyo. Lo que rescatas de los últimos segundos abre el editor igualmente: ahí todavía no hay ningún archivo hecho.": "When a recording stops, open it to trim and export. Turned off, the video or GIF is saved on its own to your folder, whole and just as it was recorded, and you get back to what you were doing. What you rescue from the last few seconds opens the editor either way: there is no file made yet at that point.",
  "Windows le tiene asignada la Herramienta de Recortes, y esto se la quita para dársela a winshotx. Si la tecla no responde, hay que cerrar sesión una vez para que Windows la suelte del todo.": "Windows has the Snipping Tool on that key, and this takes it away and gives it to winshotx. If the key does not respond, you have to sign out once for Windows to let go of it completely.",
  "La otra tecla de captura de Windows. Cogerla cuesta Win+S, la búsqueda, porque las dos se registran juntas; y si el Explorador sigue abriendo lo suyo, con Aplicar se reinicia y la suelta.": "The other Windows capture key. Taking it costs you Win+S, the search, because the two register together; and if Explorer keeps opening its own thing, Apply restarts it and it lets go.",
  "Desactivar sus teclas no la calla del todo: sigue saliendo desde el menú de inicio y desde otras teclas. Quitarla es lo único definitivo, y se puede volver a instalar desde la Microsoft Store cuando quieras.": "Turning its keys off does not silence it: it still opens from the Start menu and from other keys. Removing it is the only thing that settles it, and it can be installed again from the Microsoft Store whenever you want.",
  "Donde caen las capturas y los vídeos que guardas. El nombre lo pone winshotx con la fecha y la hora, y si ya existiera uno igual no lo pisa nunca.": "Where the screenshots and videos you save end up. winshotx names them with the date and the time, and it never overwrites one that already exists.",
  "Los fotogramas en crudo de lo que has grabado, que es lo que permite volver a exportar sin perder calidad. Vaciarlo no toca ni una captura guardada: solo tira lo que quedó a medias en el editor.": "The raw frames of what you have recorded, which is what lets you export again without losing quality. Emptying it does not touch a single saved capture: it only drops what was left half done in the editor.",
  "Claro, oscuro, o lo que diga Windows y cambiar con él. Es solo el color de estas ventanas; lo que capturas no cambia.": "Light, dark, or whatever Windows says and change along with it. It is only the colour of these windows; what you capture does not change.",
  "Español, inglés, o el de Windows si winshotx lo habla. Cambia al momento y no hace falta reiniciar nada.": "Spanish, English, or the one Windows uses if winshotx speaks it. It changes right away and nothing needs restarting.",
  "Las cuatro pantallas del primer día, otra vez: lo que hace cada tecla y qué elegir. Dura menos de un minuto y no cambia ningún ajuste.": "The four screens from your first day, again: what each key does and what to choose. It takes less than a minute and changes no setting.",
  ...
  "Pulsa la combinación · las que Windows se reserva no llegan hasta aquí":
    "Press the combination · the ones Windows keeps never reach here",
  "Pulsa las teclas…": "Press the keys…",

  // El tour guiado
  "Cerrar el tour": "Close the tour",
  Atrás: "Back",
  Siguiente: "Next",
  Listo: "Done",
  "Todo está en estas cuatro": "It is all in these four",
  "No hay más pantallas ni menús escondidos: lo que se puede cambiar está repartido aquí, y cada una cabe entera sin bajar.":
    "There are no other screens or hidden menus: everything you can change lives here, and each section fits without scrolling.",
  "La tecla que lo empieza todo": "The key that starts everything",
  "Congela la pantalla para que recortes con calma. Y puedes pedirle que espere 3 o 5 segundos: es la única forma de fotografiar un menú abierto, porque al pulsar el atajo se cierra.":
    "It freezes the screen so you can crop without hurrying. You can also ask it to wait 3 or 5 seconds: that is the only way to shoot an open menu, because pressing the shortcut closes it.",
  "Qué pasa al soltar el ratón": "What happens when you let go",
  "Con «Se copia sola» la imagen va al portapapeles y se acabó, cero clics. Con «Sale la barra» eliges cada vez entre copiar, guardar, editar o grabar.":
    "With «Copy it for me» the image goes to the clipboard and that is that, no clicks. With «Show the bar» you choose each time between copy, save, edit or record.",
  "Lo mismo, pero en movimiento": "The same, but moving",
  "El recorte se graba en GIF o en vídeo. Tiene su propio atajo, y el mismo que empieza la grabación es el que la termina.":
    "The crop records to GIF or video. It has its own shortcut, and the one that starts the recording is the one that ends it.",
  ...
  Espacio: "Space",
  "en pausa": "paused",
  "Tiempo grabado": "Time recorded",
  "GIF animado": "Animated GIF",
  "Vídeo MP4": "MP4 video",
  "Sonido del sistema grabándose": "System sound being recorded",
  "Micrófono grabándose": "Microphone being recorded",
  "La caché sin pérdida está ocupando mucho disco: para y exporta":
    "The lossless cache is taking up a lot of disk: stop and export",
  "¿Descartar?": "Discard?",
  "Otra vez para tirar la grabación": "Once more to throw the recording away",
  Reproducir: "Play",
  Parar: "Stop",
  "Guardando…": "Saving…",
