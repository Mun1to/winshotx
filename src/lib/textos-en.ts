...
export const EN: Record<string, string> = {
  ...
  "Al parar una grabación, abrirla para recortarla y exportarla, o dejarla guardada y seguir a lo tuyo. Lo que rescatas de los últimos segundos abre el editor igualmente: ahí todavía no hay ningún archivo hecho.": "When a recording stops, either open it to trim and export, or leave it saved and get back to what you were doing. What you rescue from the last few seconds opens the editor either way: there is no file made yet at that point.",
